...
**Domain**: yogigajanancusionworks3.com
...
|---|---|---|---|---|
| A | @ | 216.150.1.1 | Auto/300s | Required: Make yogigajanancusionworks3.com direct to the site |
| CNAME | www | 5e571c53648ccffe.vercel-dns-016.com. | Auto/300s | Optional: Make www.yogigajanancusionworks3.com also accessible |
...
3. Add records one by one according to the table:
   ...
   - Host Record(Name):
     - Top-level Domain(such as yogigajanancusionworks3.com) use "@"(some suppliers leave empty to represent @).
     - Subdomain(such as yogigajanancusionworks3.com) use prefix "@".
...
- **Subdomain Access**: If the subdomain (such as blog.yogigajanancusionworks3.com) is accessed, usually only the CNAME record in the table needs to be added.
